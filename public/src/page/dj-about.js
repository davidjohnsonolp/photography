  ...
  constructor() {
    ...
    const html = `
      ...
      <main>
        ...
        <dj-p>
            Starting in August 2016 and based in the city of Glasgow, David aims to capture all the beauty Scotland has to offer - whether it's in the inner city or on top of a Munroe.
        </dj-p>
        <dj-p>
